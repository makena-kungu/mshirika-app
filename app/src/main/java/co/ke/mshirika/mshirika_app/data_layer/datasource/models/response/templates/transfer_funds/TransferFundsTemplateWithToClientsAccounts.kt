package co.ke.mshirika.mshirika_app.data_layer.datasource.models.response.templates.transfer_funds
...
@Keep
@Parcelize
data class TransferFundsTemplateWithToClientsAccounts(
    ...
    val toAccountOptions: List<ToAccountOption>
) : Respondent {
    @Keep
    @Parcelize
    data class Currency(
